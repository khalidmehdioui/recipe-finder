...
const RecipeDetail = () => {
  ...
  return (
    <div className="p-5 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold text-[#A5A58D] mb-4">{recipe.title}</h1>
      <div className="flex flex-col md:flex-row md:space-x-6">
        ...
        <div className="flex-1 mb-4 md:mb-0">
          <h2 className="text-xl font-semibold text-[#A5A58D] mb-2">Ingredients</h2>
        ...
        <div className="flex-1">
          <h2 className="text-xl font-semibold text-[#A5A58D] mb-2">Directions</h2>
